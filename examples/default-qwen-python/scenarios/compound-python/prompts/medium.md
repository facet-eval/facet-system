...
Subagents may be available depending on your profile. When exposed,
they have their own context window and tool surface; delegate work to
them when partitioning helps (for example, scoping one task while
another runs).
